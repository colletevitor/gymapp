...
import { AppState, WorkoutSession, WorkoutSet } from '../types'
...
export const useStore = create<AppState>()(
  persist(
    (set, get) => ({
      ...
      addExercise: (data) => {
        const exercise = { id: generateId(), ...data }
      ...
      addTemplate: (data) => {
        const template = { id: generateId(), ...data }
      ...
      startSession: (templateId) => {
        const { templates, exercises, currentUserId } = get()
      ...
      finishSession: (durationMinutes, notes) => {
        ...
        const finished = { ...activeSession, durationMinutes, notes }
        set(s => ({
